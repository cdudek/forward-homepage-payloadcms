...
--
-- Name: _pages_v_blocks_action_tiles_block_tiles _pages_v_blocks_action_tiles_block_tiles_background_image_id_me; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public._pages_v_blocks_action_tiles_block_tiles
    ADD CONSTRAINT _pages_v_blocks_action_tiles_block_tiles_background_image_id_me FOREIGN KEY (background_image_id) REFERENCES public.media(id) ON DELETE SET NULL;
...
--
-- Name: _pages_v_blocks_feature_grid_block_features _pages_v_blocks_feature_grid_block_features_icon_media_id_media; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public._pages_v_blocks_feature_grid_block_features
    ADD CONSTRAINT _pages_v_blocks_feature_grid_block_features_icon_media_id_media FOREIGN KEY (icon_media_id) REFERENCES public.media(id) ON DELETE SET NULL;
...
--
-- Name: pages_blocks_action_tiles_block_tiles pages_blocks_action_tiles_block_tiles_background_image_id_media; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.pages_blocks_action_tiles_block_tiles
    ADD CONSTRAINT pages_blocks_action_tiles_block_tiles_background_image_id_media FOREIGN KEY (background_image_id) REFERENCES public.media(id) ON DELETE SET NULL;
...
--
-- Name: pages_blocks_feature_grid_block_features pages_blocks_feature_grid_block_features_icon_media_id_media_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.pages_blocks_feature_grid_block_features
    ADD CONSTRAINT pages_blocks_feature_grid_block_features_icon_media_id_media_id FOREIGN KEY (icon_media_id) REFERENCES public.media(id) ON DELETE SET NULL;
